...
Apply data generated by other tools
+++++++++++++++++++++++++++++++++++++++++++++++++++++

drompa+ uses the stats file (H3K4me3.100.tsv for example) as well as wig data (H3K4me3.100.bw for example) to reduce the computational time.
If the stats file is lacked (i.e. when applying the data generated by other tools), drompa+ automaticaly generates a light stats file and use it from then.
