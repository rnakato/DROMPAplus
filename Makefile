...
OBJS_PW = pw_main.o pw_readmapfile.o pw_makefile.o pw_gc.o pw_shiftprofile.o statistics.o alglib.o $(OBJS_UTIL)
OBJS_DD = dd_main.o dd_readfile.o $(OBJS_UTIL)

HEADS_UTIL = Makefile util.h readdata.h macro.h seq.h
...
clean:
	rm gtf2refFlat.o $(OBJS_COM) $(OBJS_PO) multibed2gene.o $(OBJS_PW) $(OBJS_DD) $(TARGET) *~

dd_main.o: dd_opt.h
pw_shiftprofile.o: pw_shiftprofile_p.h
$(OBJS_PW): $(HEADS_PW) alglib.h
$(OBJS_DD): $(HEADS_DD)
$(OBJS_GTF): $(HEADS_UTIL)
$(OBJS_COM): $(HEADS_UTIL) gene_bed.h
$(OBJS_PO):  $(HEADS_UTIL) gene_bed.h alglib.h
$(OBJS_MG):  $(HEADS_UTIL) gene_bed.h
