...
OBJS_DD = $(OBJDIR)/dd_main.o $(OBJDIR)/dd_class.o $(OBJDIR)/dd_command.o $(OBJDIR)/dd_readfile.o $(OBJDIR)/dd_draw.o $(OBJDIR)/dd_peakcall.o $(OBJDIR)/WigStats.o  $(SSPCMNOBJDIR)/ReadAnnotation.o
