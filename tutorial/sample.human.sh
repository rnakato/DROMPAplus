...
~/Dropbox/Linux/DROMPAPlus/otherbins/drompa.heatmap.py \
    -o heatmap-aroundTSS \
...
#~/Dropbox/Linux/DROMPAPlus/otherbins/drompa.heatmap.py -o heatmap-aroundTSS profile-K562-aroundTSS.ChIPread.tsv
#~/Dropbox/Linux/DROMPAPlus/otherbins/drompa.heatmap.py -o heatmap-aroundGene profile-K562-aroundGene.ChIPread.tsv
exit
